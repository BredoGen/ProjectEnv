...
internal class EnvTerminalToggleAction : DumbAwareToggleAction("Enable in Terminal") {

    override fun isSelected(event: AnActionEvent) = event.project?.let { ProjectEnvService.getInstance(it).enableTerminal } ?: true
